...
# All Apps
ggplot(data, aes(prime_genre, fill = prime_genre)) + geom_bar() + ggtitle("All App Genres") + xlab("genre") + ylab("count")

# Free Apps
ggplot(free_data, aes(TRUE.prime_genre, fill = TRUE.prime_genre)) + geom_bar() + ggtitle("Free App Genres") + xlab("genre") + ylab("count")

# Paid Apps
ggplot(cost_data, aes(FALSE.prime_genre, fill = FALSE.prime_genre)) + geom_bar() + ggtitle("Paid App Genres") + xlab("genre") + ylab("count")

# Both
ggplot(modified_data, aes(x = prime_genre, fill = isFree)) + geom_bar(position="dodge") + ggtitle("Free vs Paid App Genres") + xlab("genre") + ylab("count")
```
