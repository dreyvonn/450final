...
# All Apps
g <- ggplot(data, aes(prime_genre, fill = prime_genre))
g + geom_bar()

# Free Apps
ggplot(free_data, aes(TRUE.prime_genre, fill = TRUE.prime_genre)) + geom_bar()

# Paid Apps
ggplot(cost_data, aes(FALSE.prime_genre, fill = FALSE.prime_genre)) + geom_bar()

# Both
ggplot(modified_data, aes(x = prime_genre, fill = isFree)) + geom_bar(position="dodge")
```
